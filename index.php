...
<div class="slider-area">
        ...
        <!-- slider Area End-->
        <!-- Category Area Start-->
     <?php include "include/show_categories.php";?>
        <!-- Category Area End-->
        <!-- Latest Products Start -->

        <?php include "include/latest_products.php";?>

        <!-- Latest Products End -->
        <!-- Best Product Start -->
        <?php include "include/best_products.php";?>
        <!-- Best Product End-->
        <!-- Best Collection Start -->
         <?php include "include/best_collection.php";?>
        <!-- Best Collection End -->
        <!-- Latest Offers Start -->
        <?php include "include/latest_offers.php";?>
        <!-- Latest Offers End -->
        <!-- Shop Method Start-->
